...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init_template(){
        ...
        */
		...
		var langaugeBtn = document.querySelectorAll('[data-lang]');
		if(langaugeBtn.length){
			langaugeBtn.forEach(el => el.addEventListener('click',e =>{
				var expires = new Date();
				expires.setTime(expires.getTime() + (10 * 365 * 24 * 60 * 60));		
				expires = expires.toUTCString();
				var path = "/17f95c00-4ab0-492d-94a6-3a647e5ea2fe";
				var cookieString = "FTPWALNG=" + (el.getAttribute('data-lang') || "en")  +";expires="+ expires + "; path="+ path; 
